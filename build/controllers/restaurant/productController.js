...
export const createProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, price, category_id, description, images, preparationTime } = req.body;
    ...
    try {
        ...
        yield Category.findByIdAndUpdate(category_id, { $push: { products: newProduct } }, { new: true });
...
export const updateProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updatedProduct = yield Product.findByIdAndUpdate(productId, updates, {
            new: true,
        });
        res.json({
            success: true,
...
export const deleteProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield Category.findByIdAndUpdate(product.category_id, {
...
export const getProductsByRestaurant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        let populateOptions = { path: "category_id", select: "name" };
        if (authHeader) {
            const token = authHeader.split(" ")[1];
            const decoded = jwt.verify(token, process.env.JWT_SECRET);
        ...
        const response = {
            ...
            products: products.map((product) => (Object.assign({ id: product._id, name: product.name, price: product.price, description: product.description, images: product.images, isAvailable: product.isAvailable, category: product.category_id }, (product.get("ingredients") && {
